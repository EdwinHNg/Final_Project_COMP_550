...
\item \textit{Feature vector representation:} Word2vec is used in order to textually represent each tweet from their list of words. It allows for word embeddings where words are related according to their contexts. Thus, the use of word2vec representation makes the pre-processing of tweets more robust since the meaning of the words are then sustained across different contexts.
\end{enumerate}
